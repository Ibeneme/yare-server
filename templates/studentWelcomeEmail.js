module.exports = ({ firstName, email, password }) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
        ...
        <table role="presentation" width="100%" style="max-width:600px;background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.05);border:1px solid #e5e7eb;" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#1A5F3A 0%,#2D7A56 100%);color:white;padding:32px 24px;text-align:center;">
              ...
              <p style="margin:0;font-size:16px;opacity:0.9;">Your Digital Classroom</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 24px;">
              <h2 style="margin:0 0 16px 0;font-size:20px;font-weight:600;color:#1A5F3A;">Hi ${firstName},</h2>
              <p style="margin:0 0 24px 0;font-size:16px;color:#4B5563;">
                Your student account has been created successfully. You can now join your classes and begin learning from home.
              </p>
              ...
              <table role="presentation" width="100%" style="background-color:#F9FAFB;border:1px solid #E5E7EB;border-radius:12px;padding:20px;margin-bottom:24px;font-family:'Courier New',monospace;" cellspacing="0" cellpadding="0">
                <tr>
                  <td style="padding:0 0 12px 0;font-size:15px;">
                    <strong style="color:#1F2937;font-weight:600;">Email:</strong> ${email}
                  </td>
                </tr>
                <tr>
                  <td style="padding:0;font-size:15px;">
                    <strong style="color:#1F2937;font-weight:600;">Password:</strong> ${password}
                  </td>
                </tr>
              </table>
              ...
              <div style="background-color:#FFFBEB;border:1px solid #FCD34D;border-radius:10px;padding:16px;margin:20px 0;font-size:14px;color:#92400E;">
                <strong style="color:#B45309;">Please have your parent or guardian change this password after your first login.</strong>
              </div>

              <!-- CTA Button -->
              <div style="text-align:center;margin:32px 0;">
                <a href="https://yare.ng/student-login" 
